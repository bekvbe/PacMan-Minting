...
const Welcome = () => {
    ...
    const handleSubmit = (e) => {
        const { addressTo, tokenID } = formData;

        e.preventDefault();

        if (!addressTo || !tokenID) return;
            ...
            <div className="flex mf:flex-row flex-col items-start justify-between mf:p-20 py-12 px-4">
                <div className="flex flex-1 justify-start items-start flex-col mf:mr-10">
                    <h1 className="text-3xl sm:text-5xl text-white text-gradient py-1">
                        Send your NFT <br /> to anyone
                    </h1>
                    <p className="text-left mt-5 text-white font-light md:w-9/12 w-11/12 text-base">
                        NFT simplified. Mint and send your NFT to anyone, anywhere.
                    </p>
                    ...
                    <div className="grid sm:grid-cols-3 grid-cols-2 w-full mt-10">
                        ...
                        <div className={commonStyles}>Fractal NFT</div>
                ...
                <div className="flex flex-col flex-1 items-center justify-start w-full mf:mt-0 mt-10">
                    ...
                    <div className="p-5 sm:w-96 w-full flex flex-col justify-start items-center blue-glassmorphism">
                        ...
                        <Input placeholder="Token ID" name="tokenID" type="number" handleChange={() => { }} />
